...
| `test/charts_test.dart` | 3 | The pure `returnBarParts` data prep for the cost→value stacked bar: nav = cost+income+gain, after-tax value = nav−tax, a sold lot folds in realized gain + gains tax, and a price drop makes the gain part negative. |
