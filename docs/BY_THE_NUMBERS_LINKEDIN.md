...
I built a 4-platform investing app with Claude Code in ~15 hours. Here's what it actually cost.
...
• 96 commits over ~3 weeks

⏱️ What it took me
• ~15 hours of genuine hands-on steering (the rest is split across other apps I was building in the same window)

💸 What it cost
• Subscription: ~$100 (started on the $20 Pro plan, upgraded to $100 Max)
• That same workload on the pay-as-you-go API would've been ≈ $1,330
• ~13× more compute than I paid in cash

Here's the part I didn't expect:

99.97% of the token volume was cache reads — the full context re-read on every single turn, ~6,700 times. 2 billion cached tokens. On the API that's ~$1,000 of the bill. On a flat-rate plan, it's free headroom.
